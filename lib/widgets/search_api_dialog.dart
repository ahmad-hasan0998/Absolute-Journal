...
class _SearchApiDialogState extends State<SearchApiDialog> {
  ...
  void _addMediaWithOptions(
    ...
    MediaItem newItem = MediaItem(
      ...
      title: apiItem['title'],
      type: apiItem['type'],
      status: action == 'Completed' || action == 'Top5'
          ? 'Completed'
          : 'Active',
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _addMediaWithOptions(item, 'WatchLater');
                },
              ),
              ListTile(
                leading: const Icon(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ? [
                  BoxShadow(
                    color: const Color(0xFF0A2463).withValues(alpha: 0.3),
                    blurRadius: 15,
